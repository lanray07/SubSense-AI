...
app_settings = dict(base, PRODUCT_BUNDLE_IDENTIFIER="com.subsense.app", PRODUCT_NAME="SubSense", MARKETING_VERSION="1.0", CURRENT_PROJECT_VERSION="1", INFOPLIST_FILE="SubSense/Resources/Info.plist", ASSETCATALOG_COMPILER_APPICON_NAME="AppIcon", INFOPLIST_KEY_UILaunchScreen_Generation="YES", INFOPLIST_KEY_UIApplicationSceneManifest_Generation="YES", SWIFT_EMIT_LOC_STRINGS="YES", LD_RUNPATH_SEARCH_PATHS="$(inherited) @executable_path/Frameworks")
app_config = config_list("App", app_settings)
test_config = config_list("UITests", dict(base, PRODUCT_BUNDLE_IDENTIFIER="com.subsense.app.uitests", PRODUCT_NAME="SubSenseUITests", TEST_TARGET_NAME="SubSense", LD_RUNPATH_SEARCH_PATHS="$(inherited) @executable_path/Frameworks @loader_path/Frameworks"))
